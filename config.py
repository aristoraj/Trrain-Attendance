...
# ─── Check-in Window ─────────────────────────────────────────────────────────
# After this HH:MM time (IST), new check-ins are blocked (/api/verify returns 403).
# Check-out (/api/checkout) is NOT affected — trainees can still check out after this time.
CHECKIN_CUTOFF_TIME = os.environ.get("CHECKIN_CUTOFF_TIME", "16:50")
